            ...
            @forelse($products as $p)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.products.edit', $p) }}" class="fw-semibold text-decoration-none">
                            {{ $p->name }}
                        </a>
                        @if($p->sku)
                    ...
                    <td class="text-center">
                        {{-- Nút XEM mới thêm --}}
                        <a href="{{ route('admin.products.show', $p) }}" class="btn btn-info btn-sm me-1">
                            <i class="bi bi-eye"></i> Xem
                        </a>

                        {{-- Sửa --}}
                        <a href="{{ route('admin.products.edit', $p) }}" class="btn btn-warning btn-sm me-1">
